...
La Fase Tres III (tres) del proyecto de arquitectura empresarial (AE) de la $CLIENTE (SG) contiene y desarrolla el dominio de los sistemas de información de SG y arquitectura de aplicaciones.
